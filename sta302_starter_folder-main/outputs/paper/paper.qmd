...
The data is of (@Figure-1), from @palmerpenguins. This paper has divided the population into 9 different scenerios.  In Figure 1, it shows the what are the remaining balance for people in different scenarios.
